(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'knockout', 'jquery', 'toastr', 'koco-object-utilities', 'lodash', 'koco-mapping-utilities', 'koco-disposer', 'i18next'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('knockout'), require('jquery'), require('toastr'), require('koco-object-utilities'), require('lodash'), require('koco-mapping-utilities'), require('koco-disposer'), require('i18next'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.knockout, global.jquery, global.toastr, global.kocoObjectUtilities, global.lodash, global.kocoMappingUtilities, global.kocoDisposer, global.i18next);
        global.contentDialogSearchBaseViewmodel = mod.exports;
    }
})(this, function (exports, _knockout, _jquery, _toastr, _kocoObjectUtilities, _lodash, _kocoMappingUtilities, _kocoDisposer, _i18next) {
    'use strict';
