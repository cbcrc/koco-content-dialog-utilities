...
ContentDialogSearchViewModelExtender.prototype.activate = function() {
  ...
  if (self.loadLookups) {
    return self.loadLookups().then(() => self.start());
  }
...
ContentDialogSearchViewModelExtender.prototype.search = function() {
  ...
  self.searchQuery = self.api
    ...
    .then(function() { // this acts like always since there is a catch before it
      self.isSearchInProgress(false);
...
export default ContentDialogSearchViewModelExtender;
